...
FILES_TO_UPLOAD: list[tuple[str, str]] = [
    ...
    ("app/api/routers/events.py", "app/api/routers/events.py"),
    ("app/api/routers/catalog.py", "app/api/routers/catalog.py"),
    ("app/api/routers/ingest_admin.py", "app/api/routers/ingest_admin.py"),
    ("app/schemas/event.py", "app/schemas/event.py"),
    ("app/utils/image_urls.py", "app/utils/image_urls.py"),
    ("app/services/event_freshness.py", "app/services/event_freshness.py"),
    ("app/services/event_cleanup.py", "app/services/event_cleanup.py"),
    ("app/services/event_completeness.py", "app/services/event_completeness.py"),
    ("app/services/ingest/dates_ru.py", "app/services/ingest/dates_ru.py"),
    ("app/services/ingest/runner.py", "app/services/ingest/runner.py"),
    ("app/services/ingest/__init__.py", "app/services/ingest/__init__.py"),
    ("app/services/ingest/yandex_afisha.py", "app/services/ingest/yandex_afisha.py"),
    ("app/services/ingest/adm_izh.py", "app/services/ingest/adm_izh.py"),
